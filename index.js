...
* (Scriptnya Akb).
*/
const BotName = 'Akb | Bot'; // Nama Bot Whatsapp
...
conn.sendMessage(id, 'Waalaikumsalam, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
else if (text == 'Salam'){
conn.sendMessage(id, 'Waalaikumsalam, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
else if (text == 'Bot'){
conn.sendMessage(id, 'Iya, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
else if (text == 'Halo'){
conn.sendMessage(id, 'Ya?, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
...
conn.sendMessage(id, '*_Owner Akb : wa.me/6281283883549_*' ,MessageType.text);
}
else if (text == '#grupwa'){
conn.sendMessage(id, '*_Grup WhatsApp : https://chat.whatsapp.com/FZmp5WLHurWLkme4zRK3Gk_*' ,MessageType.text);
}
else if (text == 'Akb'){
conn.sendMessage(id, 'Apa? Jalanin fitur ketik *#menu*' ,MessageType.text);
}
...
conn.sendMessage(id, 'Test 1 2 3, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya?, Jalanin fitur ketik *#menu*' ,MessageType.text);
}
...
if (text.includes("#infoig")){
  ...
  axios.get(`https://mhankbarbar.herokuapp.com/api/stalk?username=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then ((res) =>{
  conn.sendMessage(id, '[WAIT] Searching...', MessageType.text)
...
if (text.includes("#infogempa")){
  ...
  axios.get(`https://mhankbarbar.herokuapp.com/api/infogempa?apiKey=lGjYt4zA5SQlTDx9z9Ca`).then ((res) =>{
  conn.sendMessage(id, '[WAIT] Searching...', MessageType.text)
...
axios.get(`http://mhankbarbar.herokuapp.com/api/chord?q=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...', MessageType.text)
...
axios.get(`https://api.terhambar.com/ninja?nama=${teks}`).then((res) => {
	conn.sendMessage(id, 'Fitur Error', MessageType.text)
...
_${kata}_
   ...
   {
    var items = ["anime loli","anime loli sange","anime loli fackgirl","anime loli i love you"];
...
//Tolonglah bro jangan di ubah ubah Akb
